...
**IMPORTANT WARNING**: This is not a production level AI agent so it does **NOT** have all the security and saftey features that a production one has. It's for learning purposes only so I `DON'T` encourage anyone to use this aget as it is now.
